#!/usr/bin/env python3
"""
Gluten Mod Installer for Deadlock
Automatically downloads and installs the Gluten mod from DLNS Stats.

Usage: python gluten_installer.py
"""
...
# Configuration
DOWNLOAD_URL = "https://dlns-stats.co.uk/gluten/download/zip"
MOD_NAME = "Gluten"
TEMP_DIR_NAME = "gluten_mod_temp"
...
def download_mod(url, temp_dir):
    ...
    zip_path = temp_dir / "Gluten_Zip.zip"
...
def main():
    ...
    if os.name == 'nt':
        try:
            os.system(f'title {MOD_NAME} Mod Installer')
        except Exception:
            pass
    
    print("=" * 50)
    print(f"  {MOD_NAME} Mod Installer for Deadlock")
    print("  Enhanced Soul Sharing Experience")
    print("=" * 50)
    print()
